The representation of the example `hello` program [[How is a computer program stored in memory|here]] clearly shows that all information in a system is represented as a bunch of bits.
