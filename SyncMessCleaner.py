...
def main(base_path, delete_anyway=False):
...
if __name__ == "__main__":
    if len(sys.argv) > 2 and sys.argv[2] == "-d":
        ...
        print("Usage: python3 SyncMessCleaner.py /path/to/base/directory [-d]")
        print("-d flag is to force delete all conflict files")
